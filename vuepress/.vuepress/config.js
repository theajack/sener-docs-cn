...
module.exports = {
    ...
    configureWebpack: () => {
        ...
        if (NODE_ENV === 'production') {
            return {
                output: {
                    // publicPath: 'https://cdn.jsdelivr.net/gh/theajack/sener-docs-cn@gh-pages/'
                    publicPath: 'https://cdn.jsdelivr.net/gh/theajack/sener-docs-cn/docs/'
                    // publicPath: '/sener-docs-cn/' // debug
                },
                resolve: {
                    // 配置路径别名
                    alias: {
    ...
    dest: './docs/', // 打包地址
    base: '/sener-docs-cn/', // gh-pages分支这里需要改成 / 因为 cnchar.js.org的配置
        ...
        nav: [
            ...
            },
            {
                ...
                items: [
                    ...
                    {text: 'Sener-Docs', link: 'https://www.github.com/theajack/sener-docs-cn'},
